...
assert.ok(generationGapForPopulation(139) > 3.2 && generationGapForPopulation(139) < 3.7, '139-person proof tree should keep generations compact while preserving readable separation');
assert.ok(generationGapForPopulation(9099) <= 4.5, 'population spacing must remain tightly bounded on the sphere');
...
console.log('direct ancestry spine stays centered with tighter, readable proof-tree generation spacing');