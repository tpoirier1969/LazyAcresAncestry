...
assert.match(ATLAS_RELIEF_TEXTURE_URL, /Solarsystemscope_texture_8k_earth_daymap\.jpg$/, 'desktop detail layer should remain a true 8K equirectangular image');
...
console.log('high-detail antique atlas assets and Upper Peninsula anchor ok');
